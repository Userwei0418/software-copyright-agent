...
FACT_MISSING_LABELS = {
    ...
    "runtime.entrypoints": "启动入口",
    "configuration.items": "运行配置项",
        ...
        sections = (
            ...
            self._section(
                ...
                by_key, ("tech.languages", "tech.frameworks", "runtime.operating_systems",
                         "runtime.minimum_hardware", "runtime.entrypoints",
                         "configuration.items", "deployment.method", "deployment.dependencies"),
                (),
                ("开发环境", "运行环境", "部署依赖"),
            ),
            self._section(
